...
function ValidarCNPJ(excutionContext) {

		//valida se recebeu o contexto de execução
...
function ValidarCPF(executionContext) {
			...
			if(isValid) {
				...
				cpf = formContext.getAttribute(label).setValue(cpf);
						...
						Xrm.Navigation.openAlertDialog({ confirmButtonLabel: "OK", text: "CPF: " + cpf + " - Inválido"}, {
							height: 100, width:300}).then(
